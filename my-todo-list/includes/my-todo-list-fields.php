...
// Dispaly Fields Metabox Content
...
?>
    <div class="wrap todo-form">
        ...
        <div class="form-group">
            <label for="due_date"><?php esc_html_e('Due date', 'todo_domain'); ?></label>
            <input type="date" name="due_date" id="due_date" value="<?php if (!empty($mtl_todo_stored_meta['due_date'][0])) {
                                                                        echo ($mtl_todo_stored_meta['due_date'][0]);
                                                                    } ?>">
